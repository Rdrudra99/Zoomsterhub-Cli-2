    ...
    return (
        <MaxWidthWrapper className="container mx-auto px-8 mb-40">
            <AnimationContainer delay={0.1} className="w-full">
                ...
                <p className="mt-4">
                    At <strong>Zoomsterhub</strong>, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services.
                </p>
                ...
                <p className="mt-8 font-medium">
                    By using Zoomsterhub, you acknowledge that you have read, understood, and agree to the terms of this Privacy Policy.
                </p>
            </AnimationContainer>
        </MaxWidthWrapper>
    );
