    ...
    return (
        ...
        >
            ...
            <text
                ...
                strokeWidth="0.3"
                className="font-[helvetica] font-bold stroke-neutral-800 fill-transparent text-[2.7rem]"
            ...
            <motion.text
                ...
                dominantBaseline="middle"
                strokeWidth="0.3"
                className="font-[helvetica] font-bold fill-transparent text-[2.7rem] stroke-neutral-800"
